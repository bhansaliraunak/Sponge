...
@Component({
  selector: 'app-weekly-premium-subscription',
  templateUrl: './weekly-premium-subscription.component.html',
  styleUrls: ['./weekly-premium-subscription.component.scss'],
})
export class WeeklyPremiumSubscriptionComponent implements OnInit {
  survey;

...
@Component({
  selector: 'app-monthly-custom-subscription',
  templateUrl: './monthly-custom-subscription.component.html',
  styleUrls: ['./monthly-custom-subscription.component.scss'],
})
export class MonthlyCustomSubscriptionComponent implements OnInit {
  message: string;

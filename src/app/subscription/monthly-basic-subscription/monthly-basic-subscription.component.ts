...
@Component({
  selector: 'app-monthly-basic-subscription',
  templateUrl: './monthly-basic-subscription.component.html',
  styleUrls: ['./monthly-basic-subscription.component.scss'],
})
export class MonthlyBasicSubscriptionComponent implements OnInit {
  survey;
